...
<div class="container">
    <!-- Modal -->
    <div class="modal fade" id="myModalPuesto" role="dialog" data-backdrop="static" 
         data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3>Fomulario Para Administrar Puestos Del Sistema</h3>
                </div>
                <div class="modal-body">
                    <!--Formilario para agregar Puestos -->
                    <form class="form-horizontal"  modelAttribute="empleado" id="frmPuesto">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="nombre">Nombre Puesto:<b style="color: red" title="Campo Requerido">*</b></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nombrePuesto" placeholder="Ingrese puesto" required>
                            </div>
                        </div>
                    </form> 
                </div><!--modal body-->
                ...
                <div  class="col-md-12">
                    <div class="table-responsive">
                        <table id="tablePuesto" class="table table-striped">
                            <thead>
                                <tr>                            
                                    <th>No</th>
                                    <th>Puesto</th>
